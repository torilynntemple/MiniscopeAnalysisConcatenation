...
ms = msGenerateVideoObj_ConcatenateBatch(pwd,'msCam');
...
%% 4 - Analyse behavior (optional)
if analyse_behavior
    behav = msGenerateVideoObj_ConcatenateBatch(pwd,'behavCam');
